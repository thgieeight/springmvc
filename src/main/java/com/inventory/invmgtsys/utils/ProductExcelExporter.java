...
public class ProductExcelExporter {
    ...
    public ProductExcelExporter(List<ProductDto> productDtoList) {
    ...
    private void writeDataLines() {
        ...
        for (ProductDto productDto : productDtoList) {
            ...
            createCell(row, columnCount++, productDto.getAddedDate(), style);
            createCell(row, columnCount++, productDto.getStatus(), style);
        }
    }
